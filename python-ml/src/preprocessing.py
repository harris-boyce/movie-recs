...
class FeatureEngineer:
    ...
    def create_rating_features(self, movies: List[Movie]) -> np.ndarray:
        ...
        self.feature_names.extend([
            "rating_average", "rating_count_log", "rating_interaction",
    ...
    def create_cast_crew_features(self, movies: List[Movie]) -> np.ndarray:
        ...
        self.feature_names.extend([
            "cast_size", "crew_size",
            "cast_avg_age", "cast_gender_balance", "cast_known_ratio",
            "crew_avg_age", "crew_gender_balance", "crew_known_ratio"
        ])
    ...
    def process_movies(self, 
                      movies: List[Movie], 
                      fit: bool = True,
                      include_text: bool = True) -> Tuple[np.ndarray, List[str]]:
        """
    ...
    def export_features(self, 
                       ...
                       output_dir: str,
                       format_types: List[str] = None) -> Dict[str, str]:
        """
...
if __name__ == "__main__":
    ...
    if features.size > 0:
        exported = engineer.export_features(
            features, sample_movies, feature_names, 
            "data/processed", ['json', 'numpy']
        )
