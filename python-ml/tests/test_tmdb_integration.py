...
class TestTMDBIntegration(unittest.TestCase):
    ...
    def test_get_movie_details_with_credits(self):
        ...
        result = self.client.get_movie_details(movie_id, append_to_response=["credits", "videos"])
    ...
    def test_discover_movies_real_api(self):
        ...
        result = self.client.discover_diverse_movies(sort_by="popularity.desc", page=1)
    ...
    def test_discover_with_genre_filter(self):
        ...
        result = self.client.discover_diverse_movies(with_genres=[28], sort_by="vote_average.desc", page=1)  # Action
    ...
    def test_discover_with_diversity_requirements(self):
        ...
        result = self.client.discover_diverse_movies(
            sort_by="popularity.desc", page=1, diversity_requirements={"min_genre_diversity": 3, "min_decade_spread": 2}
        )
    ...
    def test_comprehensive_movie_data_extraction(self):
        ...
        movie = self.client.get_movie_details(
            movie_id,
            append_to_response=["credits", "videos", "images", "keywords", "reviews", "similar", "translations"],
        )
...
class TestTMDBPerformance(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = EnhancedTMDBClient(api_key=cls.api_key, rate_limit_per_second=3.0)
    ...
    def test_diversity_analysis_performance(self):
        ...
        result = self.client.discover_diverse_movies(
            sort_by="popularity.desc", page=1, diversity_requirements={"min_genre_diversity": 5, "min_decade_spread": 3}
        )
