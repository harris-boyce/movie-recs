...
from src.feature_utils import FeatureNameMapper, ScalingUtilities, CategoryEncoder, FeatureSelector
        ...
        self.sample_movies = [
            Movie(
                ...
                cast=[
                    ...
                    PersonInfo(name="Morgan Freeman", role="actor", birth_year=1937, gender="male")
                ],
                crew=[
                    PersonInfo(name="Frank Darabont", role="director", birth_year=1959, gender="male")
                ],
            ...
            Movie(
                ...
                cast=[
                    PersonInfo(name="John Travolta", role="actor", birth_year=1954, gender="male"),
                    PersonInfo(name="Uma Thurman", role="actor", birth_year=1970, gender="female")
                ],
                crew=[
                    PersonInfo(name="Quentin Tarantino", role="director", birth_year=1963, gender="male")
                ],
                metadata=Metadata(language=Language.EN, country="US"),
                data_source="test"
            ),
