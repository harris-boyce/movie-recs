...
class TestPipelineIntegration(unittest.TestCase):
    ...
    def test_bias_detection_with_biased_dataset(self):
        ...
        self.assertGreater(bias_metrics.overall_bias_score, 0.3, 
    ...
    def test_feature_engineering_scalability(self):
        ...
        self.assertGreater(movies_per_sec, 1.0,
    ...
    def test_concurrent_pipeline_execution(self):
        ...
        if len(sample_data) > 0:
            ...
            for i in range(3):
                start_time = time.time()
                features, feature_names = engineer.process_movies(valid_movies, include_text=False)  # Faster without text
                cycle_time = time.time() - start_time
    ...
    def test_export_format_consistency(self):
        ...
        exported_files = engineer.export_features(
            features, valid_movies[:3], feature_names,
            str(export_dir),
...
class TestPerformanceBenchmarks(unittest.TestCase):
    ...
    def test_validation_performance_benchmark(self):
        ...
        for size in sizes:
            ...
            # Performance assertions
            self.assertLess(validation_time, size * 0.1, 
                           f"Validation too slow for {size} movies")
