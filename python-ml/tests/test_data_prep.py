...
class TestPipelineConfig(unittest.TestCase):
    ...
    def test_invalid_numeric_values(self):
        ...
        bad_config = {
            ...
            'quality_thresholds': {
                'completeness_min': 1.5  # > 1.0 (invalid)
            }
        }
...
class TestDataPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_config = {
            'data_sources': {
                ...
                'local_fallback': {
                    'path': str(self.temp_dir / 'test_movies.json')
                }
            },
            'download': {
    ...
    def test_full_pipeline_success(self, mock_feature_engineer, mock_validator, mock_downloader):
        ...
        mock_validator_instance.validate_dataset.return_value = (validation_result, valid_movies)
        ...
        pipeline._load_movie_data = Mock(return_value=[
            {
                "movie_id": "1",
                "title": "Test Movie",
    ...
    def test_pipeline_failure_handling(self):
        ...
        bad_config = {
            ...
            'quality_thresholds': {
                'completeness_min': 0.99  # Too strict
            }
        }
    ...
    def test_minimal_dataset_creation(self):
        ...
        required_fields = ['movie_id', 'title', 'synopsis', 'release_year', 'genres', 'ratings']
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {
                'data_sources': {
                    'primary': 'local_fallback',
                    'local_fallback': {
                        'path': str(temp_path / 'movies.json')
                    }
                },
                'download': {
            ...
            results = pipeline.run_full_pipeline(
                skip_download=True,  # Use existing data
                export_formats=['json']
            )
