...
class TestConstitutionalAIIntegration(unittest.TestCase):
    ...
    def test_diversity_improvement_algorithm(self):
        ...
        self.assertTrue(self.client._improves_diversity(movie_new_genre, current_stats, requirements))
        ...
        self.assertTrue(self.client._improves_diversity(movie_new_country, current_stats, requirements))
        ...
        self.assertTrue(self.client._improves_diversity(movie_new_language, current_stats, requirements))
        ...
        self.assertTrue(self.client._improves_diversity(movie_new_decade, current_stats, requirements))
        ...
        empty_stats = {"genres": set(), "countries": set(), "languages": set(), "decades": set()}

        self.assertTrue(self.client._improves_diversity(movie_no_improvement, empty_stats, requirements))

        # But False when stats are already populated
        self.assertFalse(self.client._improves_diversity(movie_no_improvement, current_stats, requirements))
    ...
    def test_diversity_filter_application(self):
        ...
        requirements = {"min_genre_diversity": 4, "min_results": 3}
